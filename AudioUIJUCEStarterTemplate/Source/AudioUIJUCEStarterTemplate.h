...
/*******************************************************************************
 ...
 name:             AudioUIJUCEStarterTemplate
 version:          1.0.0
 vendor:           JUCE
 ...
 type:             AudioProcessor
 mainClass:        AudioUIJUCEStarterTemplateAudioProcessorWrapper
...
//==============================================================================
class AudioUIJUCEStarterTemplateAudioProcessor  : public AudioProcessor
{
public:
    //==============================================================================
    AudioUIJUCEStarterTemplateAudioProcessor (AudioProcessorValueTreeState::ParameterLayout layout);
...
private:
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AudioUIJUCEStarterTemplateAudioProcessor)
};

//==============================================================================
AudioUIJUCEStarterTemplateAudioProcessor::AudioUIJUCEStarterTemplateAudioProcessor (AudioProcessorValueTreeState::ParameterLayout layout)
...
//==============================================================================
void AudioUIJUCEStarterTemplateAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
bool AudioUIJUCEStarterTemplateAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
...
void AudioUIJUCEStarterTemplateAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer,
                                                juce::MidiBuffer&)
{
...
//==============================================================================
void AudioUIJUCEStarterTemplateAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
    juce::ignoreUnused (destData);
}

void AudioUIJUCEStarterTemplateAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
//==============================================================================
class AudioUIJUCEStarterTemplateAudioProcessorEditor  : public AudioProcessorEditor, private Timer
{
public:
    explicit AudioUIJUCEStarterTemplateAudioProcessorEditor (AudioUIJUCEStarterTemplateAudioProcessor&);
...
private:
    AudioUIJUCEStarterTemplateAudioProcessor& processorRef;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AudioUIJUCEStarterTemplateAudioProcessorEditor)
};
...
std::optional<WebBrowserComponent::Resource> AudioUIJUCEStarterTemplateAudioProcessorEditor::getResource (const String& url)
{
...
//==============================================================================
AudioUIJUCEStarterTemplateAudioProcessorEditor::AudioUIJUCEStarterTemplateAudioProcessorEditor (AudioUIJUCEStarterTemplateAudioProcessor& p)
...
//==============================================================================
void AudioUIJUCEStarterTemplateAudioProcessorEditor::paint (Graphics& g)
{
    // (Our component is opaque, so we must completely fill the background with a solid colour)
    g.fillAll (getLookAndFeel().findColour (ResizableWindow::backgroundColourId));
}

void AudioUIJUCEStarterTemplateAudioProcessorEditor::resized()
{
    webComponent.setBounds (getLocalBounds());
}

class AudioUIJUCEStarterTemplateAudioProcessorWrapper  : public AudioUIJUCEStarterTemplateAudioProcessor
{
public:
    AudioUIJUCEStarterTemplateAudioProcessorWrapper()  : AudioUIJUCEStarterTemplateAudioProcessor ({})
    {}

    bool hasEditor() const override               { return true; }
    AudioProcessorEditor* createEditor() override { return new AudioUIJUCEStarterTemplateAudioProcessorEditor (*this); }
};
